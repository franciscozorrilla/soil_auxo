# Figure 6 — Metabolic complementarity increases with community size

| Panel | Shows | Contributors | Code | Inputs | Reproduce / notes |
|---|---|---|---|---|---|
| Fig. 6a | Metabolic complementarity vs community size across the 27 communities (per-community in grey, mean in colour; 746 auxotrophic strains, group sizes 2-5) | L. Oña | code/plots.ipynb | per-community complementarity summary (L. Oña's analysis) | Contributed by L. Oña; see Data availability |
