# Supplementary Figure 9 — Auxotroph growth vs amino acid produced (LC-MS)

| Panel | Shows | Contributors | Code | Inputs | Reproduce / notes |
|---|---|---|---|---|---|
| Supplementary Fig. 9 | Auxotroph growth vs amount of amino acid produced (LC-MS/MS) | G. Yousif | LC-MS/MS analysis | LC-MS/MS measurements | Correlation of growth with metabolite production, n = 22 |
