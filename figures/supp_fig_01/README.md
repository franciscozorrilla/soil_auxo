# Supplementary Figure 1 — Locations of the soil sampling sites

| Panel | Shows | Contributors | Code | Inputs | Reproduce / notes |
|---|---|---|---|---|---|
| Supplementary Fig. 1 | Locations of the nine soil sampling sites | G. Yousif | Sampling-site map | site coordinates | Map of sampling sites |
