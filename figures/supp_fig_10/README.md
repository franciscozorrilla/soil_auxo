# Supplementary Figure 10 — Predicted metabolite exchange network

| Panel | Shows | Contributors | Code | Inputs | Reproduce / notes |
|---|---|---|---|---|---|
| Supplementary Fig. 10 | Predicted metabolite-exchange network for the focal community | G. Yousif (figure); F. Zorrilla (SMETANA data) | analysis/05_smetana_crossfeeding/ | data/smetana/ (SMETANA v1.1.0 --detailed) | SMETANA metabolite-exchange predictions |
