# Supplementary Figure 11 — Distribution of unadjusted phyloglm P-values

| Panel | Shows | Contributors | Code | Inputs | Reproduce / notes |
|---|---|---|---|---|---|
| Supplementary Fig. 11 | Distribution of unadjusted phyloglm P-values across genes | F. Zorrilla | analysis/03_phylogenetics/phylogenetic.Rmd | data/figure_data/genes_plr.tsv | P-value distribution for the 260-gene set |
