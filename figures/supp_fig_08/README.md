# Supplementary Figure 8 — Auxotrophy number vs coculture growth

| Panel | Shows | Contributors | Code | Inputs | Reproduce / notes |
|---|---|---|---|---|---|
| Supplementary Fig. 8 | Number of auxotrophies vs tendency to grow in coculture | L. Oña | code/plots.ipynb | coculture growth measurements | Spearman correlation, n = 23 |
