# Supplementary Figure 2 — Community-level profile of metagenomic samples

| Panel | Shows | Contributors | Code | Inputs | Reproduce / notes |
|---|---|---|---|---|---|
| Supplementary Fig. 2 | Community-level phylum profile of the nine metagenomic samples | G. Yousif | Metagenome taxonomic composition | metagenome taxonomic profiles | Phylum relative abundance per sample |
