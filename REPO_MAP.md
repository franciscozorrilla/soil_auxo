...
| **Fig 4a** | Annotated genes per Mbp (metagenomic / prototroph / auxotroph) | `metabolic_modeling_soil.Rmd`; `code/plots.ipynb` | `figure3panelC.tsv` | **F. Zorrilla** (analysis); **L. Oña** (render) | medians **934** (auxo, n=53) / **880** (proto, n=9); Mann-Whitney BH P = 0.013, W = 106 |
| **Fig 4b** | Insertion sequences per Mbp | `metabolic_modeling_soil.Rmd`; `code/plots.ipynb` (cell 40) | `figure3panelD.tsv` ← `ISfinder_k1000.tsv` | **F. Zorrilla** (analysis); **L. Oña** (render) | medians **227** (auxo, n=53) / **5.1** (proto, n=9); Mann-Whitney BH P = 0.016, W = 99 |
