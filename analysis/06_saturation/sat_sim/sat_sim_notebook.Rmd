...
# This notebook uses the tidyverse; it also relies on the `auxolab` and `metadata` objects
# created in ../../04_genome_features/metabolic_modeling_soil.Rmd -- run that notebook first.
library(tidyverse)
```
